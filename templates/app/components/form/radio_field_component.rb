...
module Form
  # Wraps a radio button with label and optional description
  #
  # @example Radio with label
  #   <%= render Form::RadioFieldComponent.new do %>
  #     <%= render Form::RadioComponent.new(name: "plan", value: "basic") %>
  #     <%= render Form::LabelComponent.new { "Basic Plan" } %>
  #   <% end %>
  #
  # @param class [String] Additional CSS classes
  class RadioFieldComponent < ApplicationComponent
    attr_reader :options
